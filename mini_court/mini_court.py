...
class MiniCourt():
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points, curr_index):
        player_heights = {
            1: constants.PLAYER_1_HEIGHT_METERS[curr_index-1],
            2: constants.PLAYER_2_HEIGHT_METERS[curr_index-1]
        }
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            print("Player BBox: " + str(player_bbox))
