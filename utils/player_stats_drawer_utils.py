...
def draw_player_stats(output_video_frames,player_stats):
    ...
    for index, row in player_stats.iterrows():
        ...
        player_1_prob = row['player_1_last_prob']
        player_2_prob = row['player_2_last_prob']
        ...
        text = f"Win Probability: {player_1_prob:.1f}%    {player_2_prob:.1f}%"
        output_video_frames[index] = cv2.putText(output_video_frames[index], text, (start_x+10, start_y+240), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
